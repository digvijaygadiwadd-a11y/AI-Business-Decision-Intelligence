    ...
    if (this.state.hasError) {
      return (
        <div className="p-6 bg-red-50 border border-red-200 rounded-lg max-w-lg mx-auto mt-10">
          <h2 className="text-lg font-bold text-red-800">Something went wrong in this component chunk.</h2>
          <p className="text-sm text-red-600 mt-2">{this.state.error?.toString()}</p>
          <button 
